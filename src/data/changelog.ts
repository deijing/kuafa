...
export const CHANGELOG_DATA: ChangelogItem[] = [
  {
    version: "v1.4.0",
    date: "2026-08-14",
    title: "极简图生图封面 · 16:9 与 4K 超清画质 · 批量制作画质自由定制",
    tag: "🚀 重点迭代",
    isLatest: true,
    highlights: [
      "纯粹极简 AI 封面图生图：彻底移除繁杂模板预设，极简直观出图",
      "16:9 横版画幅与 4K 超高清海报：智能混剪、批量生成与封面工作台全景升级",
      "电商带货黄金分割提示词：右侧主播人物实拍特写，左侧吸睛大字报，绝不遮挡主播面部",
      "批量制作与智能混剪支持输出画质自由选择（4K / 2K / 1080P / 720P）",
      "后端 FFmpeg 动态编码分辨率与 CRF 无损画质全链路打通",
      "彻底移除 SVG 兜底居中白框与伪按钮，升级为 1920×1080 4K 高清等比矢量海报",
    ],
    details: [
      {
        type: "feature",
      ...
      {
        type: "feature",
        text: "16:9 比例与 4K 超高清海报输出：成片与批量生成自动提取 3 帧画面，默认生成 16:9 横版 4K 超高清电商爆款大字报海报。",
      },
      {
        type: "feature",
      ...
      {
        type: "style",
        text: "全景自适应宽高比：封面工作台与成片详情画廊自适应 16:9 (aspect-video) 宽屏高清展示。",
      },
      {
        type: "fix",
        text: "彻底解决旧版 SVG 兜底居中白框遮挡人脸及底部伪小黄车按钮问题，升级为 1920×1080 4K 高清等比矢量海报。",
      },
    ],
  },
  {
